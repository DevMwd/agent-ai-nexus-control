      ...
      <CardContent className="p-6 flex-grow">
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-center gap-2">
            <div className="bg-gray-100 rounded-lg p-2 h-12 w-12 flex items-center justify-center overflow-hidden">
              {model.logo ? (
                <Avatar className="h-full w-full">
                  <AvatarImage src={model.logo} alt={model.name} className="object-cover" />
                  <AvatarFallback><Brain className="h-6 w-6 text-gray-700" /></AvatarFallback>
                </Avatar>
              ) : (
            ...
            <div>
              ...
              <div className="text-gray-500 text-sm">{model.provider}</div>
            </div>
          </div>
        ...
        <div className="mb-4">
          ...
          <div className="mb-6">{model.maxContext || "Not specified"}</div>
        </div>
